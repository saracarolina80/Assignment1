...
public class ServerGameOfRopeRefereeSite{
   ...
   */
   ...
   {
      RefereeSite refereeSite;                              // referee site (service to be rendered)  -- processo q gere localmente the shared recource
      RefereeSiteInterface refSiteInter;                            // interface to the referee site
     ...
     /* service is established */
      ...
      refSiteInter = new RefereeSiteInterface(refereeSite);                            // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new RefereeSiteClientProxy (sconi, refSiteInter);    // start a service provider agent to address
