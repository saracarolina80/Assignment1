...
public class ServerGameOfRopePlayground {
   ...
   */
   ...
   {
      Playground playground;                              // playground (service to be rendered)  -- processo q gere localmente the shared recource
      PlaygroundInterface playInter;                            // interface to the playground
     ...
     /* service is established */
      ...
      playInter = new PlaygroundInterface (playground);                            // interface to the service is instantiated
     ...
     /* service request processing */
      ...
      { try
        { sconi = scon.accept ();                                    // enter listening procedure
          cliProxy = new PlaygroundClientProxy (sconi, playInter);    // start a service provider agent to address
